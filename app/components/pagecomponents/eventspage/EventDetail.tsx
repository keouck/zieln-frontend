...
const EventDetail: React.FC<EventDetailProps> = ({ event }) => {
  ...
  const { data: prevData, update } = useFetch(`/events/${eventId}?populate=*`, true);
          ...
          <LoginRequiredAlert
            ...
            buttonContent={
              <PrimaryOutlineButton
                ...
                buttonName={`${saved ? "Saved For Later" : "Save For Later "} (${event.saved_by.data.length})`}
              />
            }
          />
          <LoginRequiredAlert
            ...
            buttonContent={
              <PrimaryOutlineButton
                ...
                buttonName={`Interested (${(event.interested_by as any).data.length})`}
              />
            }
          />
        </div>
